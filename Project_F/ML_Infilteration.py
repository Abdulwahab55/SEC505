...
def ML_Infiltr(B):
    ...
    the tested traffic is clear with {the_percentage_of_normal_traffic}% with Infilteration scanning predition ML
    """)
    ...
    plt.savefig(f"Figures\\Infilteration_Analysis_Plot.png")